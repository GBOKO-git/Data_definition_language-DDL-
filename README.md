...
### 📘 Références :
- **Modèle relationnel** : [Voir le schéma ici](https://i.imgur.com/aZeHhHe.png)
- **Types de données associés** : [Voir le tableau ici](https://i.imgur.com/vx1xFvS.png)

---

## 🛠️ Instructions

1. **Créer les tables** correspondant au modèle relationnel fourni, en respectant :
   - les types de données appropriés,
   - les clés primaires et étrangères,
   - les contraintes (NOT NULL, CHECK, etc.).

2. **Ajoutez les colonnes suivantes** après la création des tables :
